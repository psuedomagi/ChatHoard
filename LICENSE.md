...
- It makes heavy use of Sebastián Ramírez's Full-StackFastAPI-Template, which is a great starting point for any FastAPI project and includes FastAPI, SQLModel, and much more. You can find it [here](https://github.com/tiangolo/full-stack-fastapi-template). That content licensed under the [MIT License](https://github.com/tiangolo/full-stack-fastapi-template/blob/master/LICENSE), Copyright 2019 Sebastián Ramírez.And none if it would be possible without the amazing Pydantic library.

-->
## ChatHoard Copyright 2024 Adam Poulemanos. All Rights Reserved.
